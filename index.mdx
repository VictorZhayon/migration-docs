---
title: "Redoc: Open source API documentation tool"
---
...
export const metadata = {
  title: 'Redoc: Open source API documentation tool',
  description: 'Learn how to use Redoc to create web-ready documentation from OpenAPI specifications'
}
...
<iframe src="https://redocly.github.io/redoc/" width="100%" height="500px" style={{ border:"1px solid #ccc",borderRadius:"4px" }} />

## Usage

Redoc is provided as a CLI tool (also distributed as a Docker image), HTML tag, and React component.

<Accordion title="  Generate documentation from the CLI" icon="terminal" iconType="solid">
...
<Accordion title="  Add an HTML element to the page" icon="code" iconType="solid">
...
Check out the [deployment documentation](./deployment/Introduction) for more options, and detailed documentation for each.
...
- Using [Redocly CLI](./deployment/redocly_cli#how-to-use-the-redocly-cli), configuration goes in the `redocly.yaml` file, or can be supplied as command line parameters, such as `--theme.openapi.disableSearch`.
...
<Columns cols={2}>
  <Card title="New to OpenAPI?" icon="newspaper" href="https://dashboard.mintlify.com/demo-3d453564/demo-3d453564/editor/deployment/redocly_cli#how-to-use-the-redocly-cli" cta="Click here">
    Try the OpenAPI starter project for a great introduction.
  </Card>
  <Card title="Ready to build?" icon="gear-code" href="https://dashboard.mintlify.com/demo-3d453564/demo-3d453564/editor/quickstart" cta="Click here">
    Go to the Redoc quickstart and get started with your existing OpenAPI file.
  </Card>
</Columns>

<Card title="Learn more" icon="display-code" href="https://github.com/Redocly/redoc" cta="Click here">
