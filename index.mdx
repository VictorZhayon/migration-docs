...
- Using [Redocly CLI](./deployment/redocly_cli), configuration goes in the `redocly.yaml` file, or can be supplied as command line parameters, such as `--theme.openapi.disableSearch`.
...
Try the [OpenAPI starter project](./deployment/redocly_cli) for a great introduction.
