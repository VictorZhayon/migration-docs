...
<Columns cols={2}>
  <Card title="New to OpenAPI?" icon="newspaper" href="/deployment/redocly_cli#how-to-use-the-redocly-cli" cta="Click here">
    Try the OpenAPI starter project for a great introduction.
  </Card>
  <Card title="Ready to build?" icon="gear-code" href="/quickstart" cta="Click here">
