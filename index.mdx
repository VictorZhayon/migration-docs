...
Try the [OpenAPI starter project](./deployment/redocly_cli#how-to-use-the-redocly-cli) for a great introduction.

### 2. Ready to build?

Go to the [Redoc quickstart](./quickstart) and get started with your existing OpenAPI file.

### 3. Learn more

Visit [Redoc on GitHub](https://github.com/Redocly/redoc) to explore the project further.
